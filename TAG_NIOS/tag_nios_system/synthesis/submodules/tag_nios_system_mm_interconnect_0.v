...
module tag_nios_system_mm_interconnect_0 (
	...
	wire  [104:0] bt_rs232_uart_avalon_rs232_slave_agent_rf_source_data;                              // bt_rs232_uart_avalon_rs232_slave_agent:rf_source_data -> bt_rs232_uart_avalon_rs232_slave_agent_rsp_fifo:in_data
	...
	wire  [104:0] bt_rs232_uart_avalon_rs232_slave_agent_rsp_fifo_out_data;                           // bt_rs232_uart_avalon_rs232_slave_agent_rsp_fifo:out_data -> bt_rs232_uart_avalon_rs232_slave_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> bt_rs232_uart_avalon_rs232_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // bt_rs232_uart_avalon_rs232_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [7:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> bt_rs232_uart_avalon_rs232_slave_agent:cp_channel
	...
	wire  [104:0] wifi_rs232_uart_avalon_rs232_slave_agent_rf_source_data;                            // wifi_rs232_uart_avalon_rs232_slave_agent:rf_source_data -> wifi_rs232_uart_avalon_rs232_slave_agent_rsp_fifo:in_data
	...
	wire  [104:0] wifi_rs232_uart_avalon_rs232_slave_agent_rsp_fifo_out_data;                         // wifi_rs232_uart_avalon_rs232_slave_agent_rsp_fifo:out_data -> wifi_rs232_uart_avalon_rs232_slave_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> wifi_rs232_uart_avalon_rs232_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                              // wifi_rs232_uart_avalon_rs232_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [7:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> wifi_rs232_uart_avalon_rs232_slave_agent:cp_channel
	...
	wire  [104:0] sd_card_ic_avalon_sdcard_slave_agent_rf_source_data;                                // sd_card_ic_avalon_sdcard_slave_agent:rf_source_data -> sd_card_ic_avalon_sdcard_slave_agent_rsp_fifo:in_data
	...
	wire  [104:0] sd_card_ic_avalon_sdcard_slave_agent_rsp_fifo_out_data;                             // sd_card_ic_avalon_sdcard_slave_agent_rsp_fifo:out_data -> sd_card_ic_avalon_sdcard_slave_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> sd_card_ic_avalon_sdcard_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // sd_card_ic_avalon_sdcard_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [7:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> sd_card_ic_avalon_sdcard_slave_agent:cp_channel
	...
	wire  [103:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> pio_0_s1_agent:cp_data
	...
	wire  [103:0] bt_rs232_uart_avalon_rs232_slave_agent_rp_data;                                     // bt_rs232_uart_avalon_rs232_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [103:0] wifi_rs232_uart_avalon_rs232_slave_agent_rp_data;                                   // wifi_rs232_uart_avalon_rs232_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [103:0] sd_card_ic_avalon_sdcard_slave_agent_rp_data;                                       // sd_card_ic_avalon_sdcard_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [103:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_008:sink_data
	...
	wire   [85:0] sdram_controller_s1_agent_rp_data;                                                  // sdram_controller_s1_agent:rp_data -> router_009:sink_data
	...
	wire   [85:0] router_009_src_data;                                                                // router_009:src_data -> sdram_controller_s1_rsp_width_adapter:in_data
	wire          router_009_src_ready;                                                               // sdram_controller_s1_rsp_width_adapter:in_ready -> router_009:src_ready
	wire    [7:0] router_009_src_channel;                                                             // router_009:src_channel -> sdram_controller_s1_rsp_width_adapter:in_channel
	...
	wire  [103:0] sdram_controller_s1_rsp_width_adapter_src_data;                                     // sdram_controller_s1_rsp_width_adapter:out_data -> rsp_demux_007:sink_data
	...
	wire    [7:0] sdram_controller_s1_rsp_width_adapter_src_channel;                                  // sdram_controller_s1_rsp_width_adapter:out_channel -> rsp_demux_007:sink_channel
	...
	wire  [103:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> sdram_controller_s1_cmd_width_adapter:in_data
	wire          cmd_mux_007_src_ready;                                                              // sdram_controller_s1_cmd_width_adapter:in_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> sdram_controller_s1_cmd_width_adapter:in_channel
