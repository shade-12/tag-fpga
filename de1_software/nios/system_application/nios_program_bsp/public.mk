...
SOPCINFO_FILE := D:/tag2/de1_hardware/hps_fpga/tag_nios_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is tag_nios_system
SOPC_NAME := tag_nios_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8
SOPC_SYSID_FLAG += --sidp=0x8
ELF_PATCH_FLAG  += --sidp 0x8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1618249170
SOPC_SYSID_FLAG += --timestamp=1618249170
ELF_PATCH_FLAG  += --timestamp 1618249170
