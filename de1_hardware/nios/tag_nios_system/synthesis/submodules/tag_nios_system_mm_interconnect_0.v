...
module tag_nios_system_mm_interconnect_0 (
	...
	wire    [9:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> bt_rs232_uart_avalon_rs232_slave_agent:cp_channel
	...
	wire    [9:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> wifi_rs232_uart_avalon_rs232_slave_agent:cp_channel
	...
	wire    [9:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> sd_card_ic_avalon_sdcard_slave_agent:cp_channel
	...
	wire  [105:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> sysid_control_slave_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // sysid_control_slave_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [9:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> sysid_control_slave_agent:cp_channel
	...
	wire   [27:0] onchip_sram_s1_agent_m0_address;                                                    // onchip_sram_s1_agent:m0_address -> onchip_sram_s1_translator:uav_address
	...
	wire  [106:0] onchip_sram_s1_agent_rf_source_data;                                                // onchip_sram_s1_agent:rf_source_data -> onchip_sram_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] onchip_sram_s1_agent_rsp_fifo_out_data;                                             // onchip_sram_s1_agent_rsp_fifo:out_data -> onchip_sram_s1_agent:rf_sink_data
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> onchip_sram_s1_agent:cp_valid
	wire  [105:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> onchip_sram_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // onchip_sram_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [9:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> onchip_sram_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> onchip_sram_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> onchip_sram_s1_agent:cp_endofpacket
	...
	wire  [105:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> switches_s1_agent:cp_data
	...
	wire  [105:0] sysid_control_slave_agent_rp_data;                                                  // sysid_control_slave_agent:rp_data -> router_006:sink_data
	...
	wire          onchip_sram_s1_agent_rp_valid;                                                      // onchip_sram_s1_agent:rp_valid -> router_008:sink_valid
	wire  [105:0] onchip_sram_s1_agent_rp_data;                                                       // onchip_sram_s1_agent:rp_data -> router_008:sink_data
	wire          onchip_sram_s1_agent_rp_ready;                                                      // router_008:sink_ready -> onchip_sram_s1_agent:rp_ready
	wire          onchip_sram_s1_agent_rp_startofpacket;                                              // onchip_sram_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          onchip_sram_s1_agent_rp_endofpacket;                                                // onchip_sram_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire  [105:0] switches_s1_agent_rp_data;                                                          // switches_s1_agent:rp_data -> router_011:sink_data
	...
	wire    [9:0] cmd_demux_001_src2_channel;                                                         // cmd_demux_001:src2_channel -> cmd_mux_006:sink1_channel
	...
	wire    [9:0] rsp_demux_006_src1_channel;                                                         // rsp_demux_006:src1_channel -> rsp_mux_001:sink2_channel
	...
	wire          onchip_sram_s1_agent_rdata_fifo_src_valid;                                          // onchip_sram_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] onchip_sram_s1_agent_rdata_fifo_src_data;                                           // onchip_sram_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          onchip_sram_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_006:in_0_ready -> onchip_sram_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> onchip_sram_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> onchip_sram_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // onchip_sram_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> onchip_sram_s1_agent:rdata_fifo_sink_error
	...
	tag_nios_system_mm_interconnect_0_router_003 router_006 (
	...
	tag_nios_system_mm_interconnect_0_router_002 router_008 (
	...
	tag_nios_system_mm_interconnect_0_router_003 router_009 (
	...
	tag_nios_system_mm_interconnect_0_router_010 router_010 (
	...
	tag_nios_system_mm_interconnect_0_router_003 router_011 (
	...
	tag_nios_system_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tag_nios_system_mm_interconnect_0_cmd_mux_001 cmd_mux_008 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tag_nios_system_mm_interconnect_0_cmd_mux_001 cmd_mux_009 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tag_nios_system_mm_interconnect_0_rsp_demux_001 rsp_demux_004 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tag_nios_system_mm_interconnect_0_rsp_demux_001 rsp_demux_008 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                             //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),          // clk_reset.reset
	...
	tag_nios_system_mm_interconnect_0_rsp_demux_001 rsp_demux_009 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tag_nios_system_mm_interconnect_0_avalon_st_adapter_008 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
